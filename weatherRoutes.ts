...
app.post('/weather', async (req: { body: { city: any; }; }, res: { status: (arg0: number) => { (): any; new(): any; send: { (arg0: { error: string; }): void; new(): any; }; }; send: (arg0: { city: any; temperature: any; description: any; }) => void; }) => {
